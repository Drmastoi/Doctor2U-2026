export type Page = 'home' | 'services' | 'contact' | 'booking' | 'innovation' | 'treatment-plan' | 'service-private-gp' | 'service-home-visit' | 'service-drivers-medicals' | 'service-health-screening' | 'service-childrens-health' | 'service-accident-injury' | 'service-life-insurance' | 'service-chronic-care' | 'service-referrals' | 'privacy' | 'pgp-manchester' | 'pgp-preston' | 'pgp-blackburn' | 'hvd-manchester' | 'hvd-lancashire' | 'same-day-doctor-manchester' | 'doctor-home-visit-manchester' | 'about-us' | 'our-doctors' | 'clinical-governance' | 'urgent-childrens-doctor-manchester' | 'emergency-uti-treatment-manchester' | 'elderly-care-home-visit-manchester' | 'chest-infection-home-visit-manchester' | 'back-pain-home-visit-manchester' | 'same-day-flu-doctor-manchester' | 'doctor-nursing-home-manchester' | 'out-of-hours-doctor-manchester' | 'post-op-care-home-visit-manchester' | 'ear-infection-home-visit-manchester';
